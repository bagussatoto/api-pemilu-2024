...
![Annotation 2024-02-15 092932](https://github.com/sandrocods/api-real-count-2024/assets/59155826/a97e733c-6029-4c03-82ad-a3eb9c242935)

[Blog Post](https://blog.sandroputra.com/post/scrapping-data-pemilu-2024-membuat-custom-web-apps-dan-deploy-ke-vercel)
...
```http
  GET https://api-real-count-2024.vercel.app/api
```
Response 
```json
{
...
```http
  GET https://api-real-count-2024.vercel.app/api/data-paslon
```
Response
```json
{
...
```http
  GET https://api-real-count-2024.vercel.app/api/data-wilayah
```
Response
```json
[
